...
Public Class ItemGroup
    Public Class Filter
        ...
        Public Overridable Function Filter(Optional ByVal SelectedRow As Integer = 0) As Boolean
            ...
            Using Con As New SQLiteConnection(Common.ConnectionString)
                Con.Open()
                Using Com As New SQLiteCommand(My.Resources.ItemGroupFilter, Con)
    ...
    Public Sub Load(ByVal Identifier As Long)
        ...
        Using Con As New SQLiteConnection(Common.ConnectionString)
            Con.Open()
            Using Com As New SQLiteCommand(My.Resources.ItemGroupSelect, Con)
    ...
    Private Sub SaveNew()
        Using Con As New SQLiteConnection(Common.ConnectionString)
            ...
            Using Tran As SQLiteTransaction = Con.BeginTransaction(IsolationLevel.Serializable)
                Using ComSave As New SQLiteCommand(My.Resources.ItemGroupInsert, Con)
    ...
    Private Sub SaveChanges()
        ...
        Using Con As New SQLiteConnection(Common.ConnectionString)
            Con.Open()
            Using ComUpdate As New SQLiteCommand(My.Resources.ItemGroupUpdate, Con)
    ...
    Public Sub Delete()
        Using Con As New SqliteConnection(Common.ConnectionString)
            Con.Open()
            Using Com As New SQLiteCommand(My.Resources.ItemGroupDelete, Con)
